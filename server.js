...
app.use('/verifyAccess',require('./routes/AccessVerify'));
...
app.use('/forgotchangepwd',require('./routes/forgotchangepassword'));
app.use('/verifychangepwd',require('./routes/verifyForgottenPWD'));
